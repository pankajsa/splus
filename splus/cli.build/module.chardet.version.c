...
static PyObject *const_str_digest_fb52573bbdcc92de2ca9f54047475815;
...
static void createModuleConstants(void) {
    const_str_digest_fb52573bbdcc92de2ca9f54047475815 = UNSTREAM_STRING_ASCII(&constant_bin[ 359525 ], 57, 0);
    const_str_digest_96baa068c2199be2cd71dcff3a585dfa = UNSTREAM_STRING_ASCII(&constant_bin[ 359582 ], 24, 0);
    const_str_digest_5f28c8ec13a43e2288b9f6b9b20df422 = UNSTREAM_STRING_ASCII(&constant_bin[ 359606 ], 5, 0);
    const_str_digest_273bc0eb91233c9ce50bbc2a025b5f82 = UNSTREAM_STRING_ASCII(&constant_bin[ 359611 ], 179, 0);
...
static PyCodeObject *codeobj_b6db86c6d4fcc7ac9593d46e30701036;

static void createModuleCodeObjects(void) {
    module_filename_obj = const_str_digest_fb52573bbdcc92de2ca9f54047475815;
    codeobj_b6db86c6d4fcc7ac9593d46e30701036 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_96baa068c2199be2cd71dcff3a585dfa, const_tuple_empty, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_b6db86c6d4fcc7ac9593d46e30701036;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_fb52573bbdcc92de2ca9f54047475815;
        UPDATE_STRING_DICT0(moduledict_chardet$version, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2);
    }
    // Frame without reuse.
    frame_b6db86c6d4fcc7ac9593d46e30701036 = MAKE_MODULE_FRAME(codeobj_b6db86c6d4fcc7ac9593d46e30701036, module_chardet$version);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_b6db86c6d4fcc7ac9593d46e30701036);
    assert(Py_REFCNT(frame_b6db86c6d4fcc7ac9593d46e30701036) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_fb52573bbdcc92de2ca9f54047475815;
    ...
    }
    {
        ...
        frame_b6db86c6d4fcc7ac9593d46e30701036->m_frame.f_lineno = 9;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_b6db86c6d4fcc7ac9593d46e30701036);
#endif
    popFrameStack();

    assertFrameObject(frame_b6db86c6d4fcc7ac9593d46e30701036);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_b6db86c6d4fcc7ac9593d46e30701036, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_b6db86c6d4fcc7ac9593d46e30701036->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_b6db86c6d4fcc7ac9593d46e30701036, exception_lineno);
    }

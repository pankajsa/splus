...
static PyObject *const_str_digest_0234bb5164339782749c29a835aab818;
...
static void createModuleConstants(void) {
    const_str_digest_36fd0a5f22ffa55f1b167216071d6ce2 = UNSTREAM_STRING_ASCII(&constant_bin[ 468596 ], 22, 0);
    const_dict_f1ec38e40adf588151bc715eb5db92e5 = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 468618 ], 7362);
    const_dict_2e033d8708b681122fdfcef1a8a4599e = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 475980 ], 13505);
    const_dict_ad12f0538dbf4f95e013e30f96df136a = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 489485 ], 946);
    const_str_digest_0234bb5164339782749c29a835aab818 = UNSTREAM_STRING_ASCII(&constant_bin[ 490431 ], 55, 0);
...
static PyCodeObject *codeobj_0afb872b14c90622ff69dcfc54e6eacb;

static void createModuleCodeObjects(void) {
    module_filename_obj = const_str_digest_0234bb5164339782749c29a835aab818;
    codeobj_0afb872b14c90622ff69dcfc54e6eacb = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_36fd0a5f22ffa55f1b167216071d6ce2, const_tuple_empty, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_0afb872b14c90622ff69dcfc54e6eacb;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_0234bb5164339782749c29a835aab818;
        UPDATE_STRING_DICT0(moduledict_idna$idnadata, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2);
    }
    // Frame without reuse.
    frame_0afb872b14c90622ff69dcfc54e6eacb = MAKE_MODULE_FRAME(codeobj_0afb872b14c90622ff69dcfc54e6eacb, module_idna$idnadata);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_0afb872b14c90622ff69dcfc54e6eacb);
    assert(Py_REFCNT(frame_0afb872b14c90622ff69dcfc54e6eacb) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_0234bb5164339782749c29a835aab818;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_0afb872b14c90622ff69dcfc54e6eacb);
#endif
    popFrameStack();

    assertFrameObject(frame_0afb872b14c90622ff69dcfc54e6eacb);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_0afb872b14c90622ff69dcfc54e6eacb, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_0afb872b14c90622ff69dcfc54e6eacb->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_0afb872b14c90622ff69dcfc54e6eacb, exception_lineno);
    }

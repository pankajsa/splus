        ...
        branch_no_1:;
        {
            ...
            }
            {
                ...
                branch_yes_5:;
                {
                    ...
                    tmp_make_exception_arg_3 = BINARY_OPERATION_MOD_UNICODE_TUPLE(tmp_left_name_3, tmp_right_name_3);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_5_complex_call_helper_star_dict(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_5_complex_call_helper_star_dict);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT((PyObject *)par_star_arg_dict);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_10_complex_call_helper_star_list(PyObject **python_pars) {
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE(__internal__$$$function_10_complex_call_helper_star_list);
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF(par_star_arg_list);

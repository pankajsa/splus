...
static PyObject *const_str_digest_ebec25905ac38ab64da55a445c68ca4c;
...
static void createModuleConstants(void) {
    const_tuple_d12d0d38133deb374cda3f2e99175f9b_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 202162 ], 1285);
    const_str_plain_Latin5_BulgarianCharToOrderMap = UNSTREAM_STRING_ASCII(&constant_bin[ 203447 ], 30, 1);
    const_str_plain_win1251BulgarianCharToOrderMap = UNSTREAM_STRING_ASCII(&constant_bin[ 203477 ], 30, 1);
    const_str_plain_BulgarianLangModel = UNSTREAM_STRING_ASCII(&constant_bin[ 203507 ], 18, 1);
    const_str_digest_f162f0e48afd9bd30970a540cb56b630 = UNSTREAM_STRING_ASCII(&constant_bin[ 203525 ], 35, 0);
    const_float_0_969392 = UNSTREAM_FLOAT(&constant_bin[ 203560 ]);
    const_str_plain_Bulgairan = UNSTREAM_STRING_ASCII(&constant_bin[ 203568 ], 9, 1);
    const_str_digest_ebec25905ac38ab64da55a445c68ca4c = UNSTREAM_STRING_ASCII(&constant_bin[ 203577 ], 68, 0);
    const_str_plain_Bulgarian = UNSTREAM_STRING_ASCII(&constant_bin[ 4576 ], 9, 1);
    const_tuple_36b7ecdab49c9829602e64b169986871_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 203645 ], 20485);
    const_tuple_33562c24091b0ac3cbee9a55801943b1_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 224130 ], 1285);
...
static PyCodeObject *codeobj_8d03c1b513c24be808061297ed2f73a5;

static void createModuleCodeObjects(void) {
    module_filename_obj = const_str_digest_ebec25905ac38ab64da55a445c68ca4c;
    codeobj_8d03c1b513c24be808061297ed2f73a5 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_f162f0e48afd9bd30970a540cb56b630, const_tuple_empty, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_8d03c1b513c24be808061297ed2f73a5;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_ebec25905ac38ab64da55a445c68ca4c;
    ...
    // Frame without reuse.
    frame_8d03c1b513c24be808061297ed2f73a5 = MAKE_MODULE_FRAME(codeobj_8d03c1b513c24be808061297ed2f73a5, module_chardet$langbulgarianmodel);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_8d03c1b513c24be808061297ed2f73a5);
    assert(Py_REFCNT(frame_8d03c1b513c24be808061297ed2f73a5) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_ebec25905ac38ab64da55a445c68ca4c;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_8d03c1b513c24be808061297ed2f73a5);
#endif
    popFrameStack();

    assertFrameObject(frame_8d03c1b513c24be808061297ed2f73a5);
    ...
    {
        exception_tb = MAKE_TRACEBACK(frame_8d03c1b513c24be808061297ed2f73a5, exception_lineno);
    }
    else if (exception_tb->tb_frame != &frame_8d03c1b513c24be808061297ed2f73a5->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_8d03c1b513c24be808061297ed2f73a5, exception_lineno);
    }
